...
libdrawit_files = [   'lib/data_structure/graph_hierarchy.cpp',
                      ...
                      'lib/drawing/coarsening/matching/random_matching.cpp',
                      'lib/drawing/coarsening/matching/gpa/path.cpp',
                      'lib/drawing/coarsening/matching/gpa/path_set.cpp',
                      'lib/drawing/coarsening/matching/gpa/gpa_matching.cpp',
