...
int graph_io::writeGraphWeightedMTX(graph_access & G, std::string filename) {
        std::ofstream f(filename.c_str());
        f << "%%MatrixMarket matrix coordinate real symmetric" << std::endl;
        f << G.number_of_nodes() << " " << G.number_of_nodes() << " " << G.number_of_edges() << std::endl;
...
void graph_io::readCoordinates(graph_access & G, std::string filename) {
        std::string line;
...
void graph_io::writeCoordinates(graph_access & G, std::string filename) {
        std::ofstream f(filename.c_str());
        forall_nodes(G, node) {
